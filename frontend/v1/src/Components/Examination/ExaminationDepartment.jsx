      ...
      <section className="w-full bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16 grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <div
              className={`bg-white rounded-2xl shadow-lg border border-slate-200 p-6 lg:p-8 animate-slide-up`}
        ...
        <div className="max-w-7xl mx-auto px-6 pb-12">
          <div
            className={`bg-slate-100 rounded-xl p-4 animate-slide-up`}
            style={{ animationDelay: "400ms" }}
          >
            <p className="text-sm text-slate-600">
              For grievances / revaluation / photocopy requests kindly mention
              your <strong>Exam Seat No</strong> and <strong>Course</strong> in
              the subject line.
            </p>
          </div>
        </div>
