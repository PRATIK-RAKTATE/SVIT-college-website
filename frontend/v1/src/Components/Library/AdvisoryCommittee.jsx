...
const AdvisoryCommittee = () => {
  ...
  const committee = [
    { sr: 1, name: "Prof. R. P. Sabale", dept: "Computer Dept", role: "Chairman", color: "from-blue-500 to-blue-600" },
    { sr: 2, name: "Prof. V. L. Kadlag", dept: "HOD Mechanical Engg", role: "Member", color: "from-green-500 to-green-600" },
    { sr: 3, name: "Prof. A. A. Hatkar", dept: "HOD E&TC", role: "Member", color: "from-purple-500 to-purple-600" },
    { sr: 4, name: "Dr. D. K. Chandre", dept: "HOD Chemical Engg", role: "Member", color: "from-orange-500 to-orange-600" },
    { sr: 5, name: "Prof. S. M. Rokade", dept: "HOD Computer", role: "Member", color: "from-pink-500 to-pink-600" },
    { sr: 6, name: "Prof. R. S. Bhalerao", dept: "HOD IT", role: "Member", color: "from-indigo-500 to-indigo-600" },
    { sr: 7, name: "Prof. N. B. Shaikh", dept: "HOD Electrical Engg", role: "Member", color: "from-teal-500 to-teal-600" },
    { sr: 8, name: "Prof. K. P. Tambe", dept: "FE Dean", role: "Member", color: "from-red-500 to-red-600" },
    { sr: 9, name: "Prof. A. P. Kare", dept: "HOD M.B.A", role: "Member", color: "from-yellow-500 to-yellow-600" },
    { sr: 10, name: "Dr. P. S. Bodake", dept: "Librarian, K.K. Wagh Engg, Nashik", role: "Member", color: "from-gray-500 to-gray-600" },
    { sr: 11, name: "Dr. Rajendra Kumbhar", dept: "HOD & Librarian, University of Pune", role: "Member", color: "from-cyan-500 to-cyan-600" },
    { sr: 12, name: "Prof. P. E. Avhad", dept: "Librarian & Secretary", role: "Member", color: "from-emerald-500 to-emerald-600" }
  ];
    ...
    <section className="relative w-full bg-gradient-to-br from-white via-blue-50 to-white py-16">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <header className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">SVIT - Pravara Institute of Technology</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {animatedMembers.map((member, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br ${member.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-xl`}></div>
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  {member.role === "Member" && member.dept.includes("Librarian") && (
        ...
        <footer className="mt-16 text-center">
          <div className="inline-flex items-center gap-3 px-8 py-4 bg-white/80 backdrop-blur-md rounded-full shadow-lg border border-gray-200">
            ...
            <span className="text-gray-700 font-medium">
              Total <span className="font-bold text-blue-600">{committee.length}</span> members including external experts
            </span>
          </div>
        </footer>
      </div>
