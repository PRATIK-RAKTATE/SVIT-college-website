...
import { Extended_Profile } from '../../Constants/NAAC/Extended-Profile.js';
        ...
        <thead className="bg-indigo-600 text-white">
          <tr>
            <th
              ...
              aria-sort={sort.key === 'criterion' ? (sort.dir === 'asc' ? 'ascending' : 'descending') : 'none'}
            >
            ...
            <th
              ...
              className="px-4 py-2 text-left font-semibold cursor-pointer"
              aria-sort={sort.key === 'description' ? (sort.dir === 'asc' ? 'ascending' : 'descending') : 'none'}
            >
              <div className="inline-flex items-center gap-1">
                Description
              ...
              <td className="px-4 py-2">
                <ul className="list-disc list-inside space-y-1">
                  {row.downloads.length ? (
                    ...
                    <li className="text-gray-500">No downloads available</li>
                  )}
                </ul>
              </td>
            </tr>
...
export default Extended_Profile_Table;
