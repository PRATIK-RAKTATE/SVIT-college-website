  ...
  return (
    ...
    <HomeSideBar deptId={deptId}/>
        <div className="mt-20 md:pr-10 md:pl-10">
          <h1 className="text-2xl font-sans md:text-4xl font-bold text-center mb-8">{deptName} Programme Outcomes</h1>
      
      <section className=" md:p-0 p-6 md:mt-15  w-auto">
        <h2 className="text-xl font-semibold mb-4">Programme Educational Objectives (PEOs)</h2>
      ...
      <section className="w-auto">
        <h2 className="text-xl font-semibold mb-4">Programme Specific Outcomes (PSOs)</h2>
        <ul className="list-disc list-inside space-y-2">
