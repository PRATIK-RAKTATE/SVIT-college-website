...
export default function HomeNav() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: "NAAC",
      items: [
        { text: "NAAC CERTIFICATE", url: "../../public/NAAC/NAAC_Certificate.pdf" },
        { text: "NAAC UNDERTAKING", url: "../../public/NAAC/NAAC_Undertaking.pdf" },
        { text: "NAAC SELF DECLARATION", url: "../../public/NAAC/NAAC_Declararion.pdf" },
        { text: "IIQA", url: "../../public/NAAC/IIQA.pdf" },
        { text: "NAAC SSR", url: "../../public/NAAC/SSR-Updated.pdf" },
        { text: "Extended Profile", url: "/naac/profile" },
        { text: "NAAC PEER TEAM REPORT", url: "../../public/NAAC/Peer_Team_Report.pdf" },
        { text: "NAAC PEER TEAM METRIC WISE SCORE REPORT", url: "../../public/NAAC/Peer_Team_Metric_Wise_Score_Report.pdf" },
        { text: "NAAC Graphical Representation based on QnM & QlM", url: "../../public/NAAC/Graphical_Representation_based_QnM_QlM.pdf" },
        { text: "2019_20_Academic_Calender ", url: "../../public/NAAC/2018_19_Academic_Calender.pdf" },
        { text: "2020_21_Academic_Calender ", url: "../../public/NAAC/2020_21_Academic_Calender.pdf" },
        { text: "AQAR_Report", url: "../../public/NAAC/AQAR.pdf" },
