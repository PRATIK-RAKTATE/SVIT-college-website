const SEO_CONFIG = {
  home: {
    title:
      "SVIT Nashik -  Sir Visvesvaraya Institute Of Technology, Nashik | Engineering & Technology",
    description:
      "Official website of SVIT Nashik. Explore departments, admissions, placements, alumni, and more.",
  ...
  departments: {
    ...
    mba: {
      ...
      description:
        "Explore mba at SVIT. Faculty, labs, syllabus, placements, and more.",
      url: "https://svitnashik.in",
      image: "https://pravaraengg.org.in/assets/img/PRES.png",
    },
  },
  alumni: {
    ...
    description:
      "Join SVIT Nashik Alumni Network. Register, connect, and explore alumni achievements.",
