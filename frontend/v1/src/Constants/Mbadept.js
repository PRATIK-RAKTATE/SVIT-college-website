const mbaDept = {
  ...
  mission:
    "To develop value based managers and entrepreneurs through cutting edge management education by motivating them through highly qualified and competent faculty equipped with latest teaching learning practices in a conducive academic ambience.",

  HODDesk: `I welcome you to the SVIT, MBA which is established in 2008. It is an addition to the galaxy of education endeavours of Pravara to provide high-tech, practical management education to the students coming from different backgrounds. It is founded by Late Padmashree Dr. Vitthalrao Vikhe Patil with a mission of development & growth of rural masses.
...
Our institute has got a separate dedicated Training & Placement cell which takes all round efforts in providing employment opportunities and industry mentored projects to all the students. Our students got placed in reputed organizations like ABB Ltd, Axis Bank, Accenture, Aegon Religare, Birla Global, Bajaj Allianz, ETON, Gateway Hotel, HDFC Bank, Hindustan National Glass, ICICI Bank, Parle Biscuits, LIC, Shopper's Stop and T.C.S etc.`,
  ...
  hodqualification:"Ph.D. (Organizational Management), M.B.A.(IT), BSc(Electronics)",
  Department:"MBA (Master of Business Administration)",

  carousel: [
    {
      img: "https://svitnashik.in/Images/Carousel/MBA/MBA_1.jpg",
      text: "Welcome to the MBA Department",
    },
    {
      img: "https://svitnashik.in/Images/Carousel/MBA/MBA_2.jpg",
      text: "Building Responsible Leaders",
    },
    {
      img: "https://svitnashik.in/Images/Carousel/MBA/MBA_3.jpg",
      text: "Industry Oriented Learning",
    },
    {
      img: "https://svitnashik.in/Images/Carousel/MBA/MBA_4.jpg",
      text: "Transforming Students into Entrepreneurs",
    },
    {
      img: "https://svitnashik.in/Images/Carousel/MBA/MBA_5.jpg",
      text: "Practical Exposure through Industry Visits",
    },
  ],
};
