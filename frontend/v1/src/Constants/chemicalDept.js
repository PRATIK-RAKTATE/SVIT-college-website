const chemicalDept = {
  ...
  mission: `1. To impart quality technical education in the field of Chemical Engineering.
2. To produce quality Chemical Engineer and Scientist as per the need of industry and society.
3. To develop entrepreneurship and leadership skill of the students.
4. To develop the responsible citizen with focus on research and innovation.`,
  ...
  img: "https://svitnashik.in/Images/Profile%20Images/Department/Chemical/Dr_Chandre.jpg",
  hodname:"Dr. Dipak K. Chandre, HOD",
  hodqualification:"M.Tech (Chemical Engg),PGD Piping Design,PhD (Chemical Engg)-ICT Mumbai,Member of ISTE, IIChE.",
  Department:"Chemical engineering",

  carousel: [
    {
      img: "https://svitnashik.in/Images/Carousel/Chemical/Chem_Dept_Large_1.jpg",
      text: "Welcome to the Chemical Department",
    },
    {
      img: "https://svitnashik.in/Images/Carousel/Chemical/Chem_Dept_Large_2.jpg",
      text: "Innovating for Industry and Society",
    },
    {
      img: "https://svitnashik.in/Images/Carousel/Chemical/Chem_Dept_Large_3.jpg",
      text: "Hands-on Research and Development",
    },
  ],
};
