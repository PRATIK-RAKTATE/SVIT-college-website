    ...
    rows: [
      {
        ...
        type: "QnM",
        description:
          "Number of gender equity promotion programs organized by the institution during the last five years. 7.1.1.1: Number of gender equity promotion Programmes organized by the institution year wise during the last five years",
        downloads: [
          {
      ...
      },
      {
        criterion: "7.1.13",
        description:
          "Display of core values in the institution and on its website (Yes/ No)",
        downloads: [
          {
            name: "Core Values",
      ...
      },
      {
        criterion: "7.1.14",
        description:
          "The institution plans and organizes appropriate activities to increase consciousness about national identities and symbols; Fundamental Duties and Rights of Indian citizens and other constitutional obligations (Yes/ No)",
        downloads: [
          {
      ...
      },
      {
        criterion: "7.1.15",
        description:
          "The institution offers a course on Human Values and professional ethics (Yes/ No)",
        downloads: [
          {
      ...
      },
      {
        criterion: "7.1.16",
        description:
          "The institution functioning is as per professional code of prescribed / suggested by statutory bodies / regulatory authorities for different professions (Yes/ No)",
        downloads: [
          {
      ...
      },
      {
        criterion: "7.1.17",
        description:
          "Number of activities conducted for promotion of universal values (Truth, Righteous conduct, Love, Non-Violence and peace); national values, human values, national integration, communal harmony and social cohesion as well as for observance of fundamental duties during the last five years. 7.1.17.1: Number of activities conducted for promotion year wise during the last five year",
        downloads: [
          {
            name: "List of Activities",
